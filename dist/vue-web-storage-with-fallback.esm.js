...
})(StorageServicesEnum || (StorageServicesEnum = {}));
...
var WebStorageManagerService = /** @class */ (function () {
    ...
    WebStorageManagerService.prototype.getKeys = function (storageType) {
        if (storageType === void 0) { storageType = StorageServicesEnum.LOCAL_STORAGE; }
...
export { WebStorage, StorageServicesEnum, IStorageService };
